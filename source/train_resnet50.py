...
# Load ResNet50 model without the top layers and modify input size
resnet50_base = ResNet50(weights='imagenet', include_top=False, input_shape=(120, 160, 3))
...
# Define the model
model = Model(inputs=resnet50_base.input, outputs=[output_binary, output_napsi])
...
# Save the model
model.save('C:/Users/RO100202/pythonProject/resnet_model.h5')
